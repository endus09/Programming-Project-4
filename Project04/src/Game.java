 ...
 public class Game
 {
     ...
     public void simulate(int turns)
     {
         for (int i = 0; i < turns; i++)
         {
             ...
             if (this.player.getPosition() == 7 || this.player.getPosition() == 22 || this.player.getPosition() == 36)
             {
                 handleChanceCard();
             } else if (this.player.getPosition() == 2 || this.player.getPosition() == 17 || this.player.getPosition() == 33)
             {
