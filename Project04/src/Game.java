...
public class Game {
    ...
    public Game(String[] chanceCards, String[] communityCards, boolean useStrategyB) {
...
// Game results printout
  private final int simulationNumber;
    ...
    public Game(String[] chanceCards, String[] communityCards, boolean useStrategyB, int simulationNumber) {
        this.chanceDeck = new Deck(chanceCards);
        this.communityChestDeck = new Deck(communityCards);
        this.dice = new Dice();
        this.landings = new int[BOARD_SIZE];
